    ...
    <head>
	 ...
	 app_hub.on_new_wallet_update_processed_block_height_event.connect(update_processed_block_height);
            ...
            function send_tx(){
                ...
                else if(!(address.substr(0, 4) === "VERa" && address.length === 99) && !(address.substr(0, 4) === "VERi" && address.length === 110)){
    ...
    <body>
            ...
            <div class="tab-content" style="height:490px; margin-top:20px;">
                ...
                <div id="balance_tab" class="tab-pane fade in active">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-xs-6">
                                <h5><font color="#000000"><i class="fa fa-fw fa-balance-scale" style="color:#000000;"></i> Balance:</font></h5>
                                <h5><font color="#000000"><i class="fa fa-fw fa-unlock" style="color:#000000;"></i> Unlocked Balance:</font></h5>
                            </div>
                            <div class="col-xs-6" style="text-align:right">
                                <h5><span id="balance">0.00</span> <small>XVV</small> <span class="syncing"> (syncing)</span></h5>
                                <h5><span id="unlocked_balance">0.00</span> <small>XVV</small> <span class="syncing"> (syncing)</span></h5>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-xs-8">
                                        <select id="send_mixins" class="form-control">
                                          ...
                                          <option value="13">13 mixins</option>
                                          <option value="14">14 mixins</option>
                                          <option value="15">15 mixins</option>
                                          <option value="16">16 mixins</option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-xs-8">
                                        <select id="send_priority" class="form-control">
                                          <option value="1">Normal (x1 fee)</option>
                                          <option value="2" selected>High (x2 fee)</option>
        ...
        <script id="recent_tx_row_templ" type="x-tmpl-mustache">
            <div class="col-sm-12">
                <div class="col-xs-10" style="padding-right:0">
                    <p class="tx-list tx-{{cls_in_out}}"><i class="fa fa-{{ tx_fa_icon }}"></i> ({{tx_direction}}) <span class="tx-list txid"><a href="javascript:open_link('https://explorer.veronite.space/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span></p>
        ...
        <script id="tx_detail_templ" type="x-tmpl-mustache">
            <p class="tx-list tx-{{cls_in_out}}" style="font-size: 90%"><i class="fa fa-{{ tx_fa_icon }}"></i> {{tx_direction}}<br>
                <span class="tx-list txid"><a href="javascript:open_link('https://explorer.veronite.space/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span>
            </p>
